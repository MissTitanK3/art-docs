...
6. **PII redaction for unauthenticated viewers.** Screens shown to unauthenticated viewers must omit personally identifying information beyond first name or role label. This preserves transparency and situational awareness while reducing screenshot harm.
