...
**🟢 ALL 16 GAPS RESOLVED/PLANNED - Sprint 0 Ready to Begin**
 ...
 **Status Enum & State Machine:**
  ...
  - Valid transitions documented (e.g., open → acknowledged → escalated → closed)
...
- Trigger: Incident in "Needs Help" >5 minutes OR fewer than 2 available responders assigned → escalate to regional lead.
...
**Plan:**
- Timing: Run sessions in Sprint 3.5–4.0; prep in Sprint 3 planning.
...
- Sprint 3.5–4.0: Run 2-3 sessions across the window; record and log findings.
...
- [x] Sessions slated for Sprint 3.5–4.0 in [gaps-status-summary.mdx](gaps-status-summary.mdx)
...
**Status:**  **PLANNED: Pre-launch checklist + rollback + CI/CD**
...
- Rollback strategy: Fast rollback via blue/green or versioned artifacts; DB rollback via backups + reversible migrations; clear stop-ship criteria.
- CI/CD pipeline: Lint/tests → build → artifact versioning → staging deploy → smoke checks → manual approval → prod deploy; add observability hooks for post-deploy validation.
...
- Sprint 6: Wire CI/CD stages (lint/test/build, artifact publish, staging deploy + smoke, manual approval, prod deploy); ensure rollback script exists; document backup/restore steps.
...
- [x] Checklist, rollback strategy, and CI/CD pipeline documented in [specs/deploy-runbook.md](specs/deploy-runbook.md)
...
| **Sprint 5** | 🟡 CONDITIONAL | Offline submission queueing + sync | Blocker #4 (offline decision) must be YES |
| **Sprint 6** |  PARTIAL | Language audit + pattern library (for Sprints 0-4 only) | Sprints 1-4 complete; defer comprehensive audit |
| **Sprint 7** | ⏭️ POST-MVP | Guardrails + audit trails | Post-MVP |
...
|---|-----|-------|----------|-------------|--------|
| B1 | Backend API contracts | Backend Lead |  Jan 17 | [Backend API Contracts Specification](/specs/backend-api-contracts) | 🟢 |
| B2 | Database schema | Backend/DB Lead |  Jan 17 | [Database Schema & Persistence Specification](/specs/database-schema) | 🟢 |
| B3 | Auth architecture | Backend/Security Lead |  Jan 17 | [Authentication Architecture](/specs/authentication-architecture) | 🟢 |
| B4 | Offline support decision | Product Lead |  Jan 17 | [Offline Support Architecture](/specs/offline-support-architecture) | 🟢 |
| B5 | Region scope decision | Product/Ops Lead |  Jan 17 | [Region Scope Architecture](/specs/region-scope-architecture) | 🟢 |
| B6 | Crisis vs. Management Mode | Product Lead |  Jan 17 | [Crisis & Management Mode Strategy](/specs/crisis-management-mode-strategy) | 🟢 |
| **7** | **MVP scope** | **Product Lead** | ** Jan 17** | **[MVP definition in gaps-status-summary.mdx](gaps-status-summary.mdx)** | **🟢** |
| **8** | **Localization path** | **i18n/Frontend Lead** | ** Jan 17** | **[Language specs updated](language/approved-copy.md)** | **🟢** |
| **9** | **Responder availability** | **Backend/Product Lead** | ** Jan 17** | **[Availability spec updated](specs/minimal-dispatch-flow.md)** | **🟢** |
| **10** | **Escalation logic** | **Backend/Product Lead** | ** Jan 17** | **[Escalation spec updated](specs/escalation-state-machine.md)** | **🟢** |

### SPRINT 0-4 TASKS

| # | Gap | Owner | Sprint | Deliverable | Status |
|---|-----|-------|--------|-------------|--------|
| 11 | User testing plan | Product/UX Lead | Sprint 3.5–4.0 | Testing sessions + findings tracker | 🟡 PLANNED |
| 12 | Mobile/PWA build | Frontend/Design Lead | Sprint 0-4 | PWA manifest, responsive layouts, performance tuned | 🟡 PLANNED |
| 15 | Manual error reporting | Backend/DevOps Lead | Sprint 1-2 | In-app report flow + triage setup | 🟡 PLANNED |

### PRE-LAUNCH TASKS (Sprint 6-8)

| # | Gap | Owner | Sprint | Deliverable | Status |
|---|-----|-------|--------|-------------|--------|
| 13 | WCAG audit | Design/QA Lead | Sprint 5-6 | Accessibility audit + fixes | 🟡 PLANNED |
| 14 | Compliance automation | QA/DevOps Lead | Sprint 6 | Language/invariant CI + checklist | 🟡 PLANNED |
| 16 | Deployment/CI-CD | DevOps/Ops Lead | Sprint 4-8 | Pre-launch checklist, rollback rehearsal, CI pipeline | 🟡 PLANNED |
...
- [Deploy Runbook](/specs/deploy-runbook.md) - Deployment strategy and CI/CD
