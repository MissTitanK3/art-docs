...
- Lightweight detail view for a single dispatch (include key metadata and history if available).
...
- [ ] Test navigation flow: list → detail → back to list (5+ round trips)
...
- [ ] CI/CD pipeline can build and test frontend code
